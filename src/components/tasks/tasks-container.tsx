...
export default function TasksContainer() {
  ...
  useEffect(() => {
    if (user && !user.isActivated) {
      toast({
        ...
        description:
          "You need to activate your account to access tasks. Go to the referrals page to activate.",
        variant: "destructive",
      });
      navigate("/referrals");
    }
  ...
  const hasReachedMaxTasks = (taskType: string) => {
    ...
    return (
      completedTasks[taskType as keyof typeof completedTasks] >= maxTasksPerType
    );
  };
