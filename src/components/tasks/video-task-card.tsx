...
export default function VideoTaskCard({ task, onComplete, maxTasksReached }: VideoTaskCardProps) {
  ...
  const startWatching = () => {
    ...
    if (maxTasksReached) {
      toast({
        ...
        description: "You've reached the maximum tasks for this category this week.",
        variant: "destructive"
      });
      return;
    }
  ...
  const getVideoEmbedUrl = () => {
    switch (task.type) {
      ...
      case 'ad':
        return "https://www.youtube.com/embed/QY7Xj08CkNc"; // Example ad video
      default:
        return "";
    }
  };
  ...
  const progressPercentage = Math.min((timeWatched / requiredWatchTime) * 100, 100);
            ...
            {cooldownActive ? (
              <div className="text-center space-y-2">
                ...
                <p className="text-center text-slate-500">
                  You've already completed this task. You can watch again {getCooldownTimeRemaining()}.
                </p>
