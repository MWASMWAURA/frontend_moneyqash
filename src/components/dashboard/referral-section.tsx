...
export default function ReferralSection({
  ...
  const shareViaWhatsApp = () => {
    const message = `Join MoneyQash and earn through referrals! Use my link: ${stats.referralLink}`;
  ...
  const shareViaOther = () => {
    if (navigator.share) {
      navigator
        .share({
          title: "Join MoneyQash",
          text: "Join MoneyQash and earn through referrals!",
            ...
            <div className="ml-3">
              ...
              <div className="mt-2 text-sm text-primary-700">
                <ul className="list-disc pl-5 space-y-1">
                  <li>First level referral: Earn KSh 300</li>
                  <li>Second Level referral: Earn KSh 150</li>
